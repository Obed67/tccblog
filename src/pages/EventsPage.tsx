      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-xl p-6 text-center">
            ...
            <p className="text-secondary font-medium">Articles publiés</p>
          </div>
          <div className="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-xl p-6 text-center">
            <p className="text-4xl font-bold text-accent-green mb-2">
              {categories.length}
            </p>
            <p className="text-secondary font-medium">Catégories</p>
          </div>
          <div className="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-xl p-6 text-center">
            <p className="text-4xl font-bold text-primary mb-2">
              {mockArticles.reduce((sum, a) => sum + a.views, 0)}
            </p>
            <p className="text-secondary font-medium">Vues totales</p>
          </div>
        </div>
                  ...
                  {articlesInCategory.map((article) => (
                    ...
                    >
                      <div className="flex-1">
                        <h4 className="font-semibold text-primary hover:text-accent transition-colors cursor-pointer">
                          {article.title}
                        </h4>
